export default function DraftPlaceholder() {
  return (
    <easteregg className="text-neutral-200 text-sm sm:text-base blur-sm select-none">
      ...
      yet, but I hope you will find the following text entertaining :D
      <br />
      <br />
      We&apos;re no strangers to love You know the rules and so do I A full
      commitment&apos;s what I&apos;m thinking of You wouldn&apos;t get this
      from any other guy
      <br />
      <br />
      ...
      You&apos;re too shy to say it Inside, we both know what&apos;s been going
      on We know the game and we&apos;re gonna play it
      <br />
      <br />
      And if you ask me how I&apos;m feeling Don&apos;t tell me you&apos;re too
      blind to see
      <br />
      <br />
      Never gonna give you up Never gonna let you down Never gonna run around
      ...
      <br />
      <br />
      (Ooh, give you up) (Ooh, give you up) Never gonna give, never gonna give
