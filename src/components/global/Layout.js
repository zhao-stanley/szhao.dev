...
export default function Layout({ children }) {
  ...
  return (
    <div className="relative flex h-full min-h-screen w-full flex-col items-center">
      <motion.nav
        className={
          "fixed top-2 lg:top-4 z-10 grid h-8 w-fit grid-cols-7 items-center rounded-full ring-1 ring-neutral-600 backdrop-blur-lg backdrop-brightness-50 sm:h-10"
        }
