    ...
    >
      <div className="flex flex-col justify-between gap-6 w-full h-full">
        ...
        <div className="flex flex-row w-full justify-between">
          {lang !== null ? (
            <div className="flex flex-row gap-1 items-center" title={lang}>
              <span
                style={{
          ...
          {link.includes("github.com") ? (
            <span className="flex flex-row gap-2">
              <div className="flex flex-row gap-1" title={`${stars} stars`}>
                <svg
              ...
              <div className="flex flex-row gap-1" title={`${forks} forks`}>
