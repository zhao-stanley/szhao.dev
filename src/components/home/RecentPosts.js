  ...
  return (
    <section className="py-10 flex flex-col gap-y-6 w-full md:max-w-2xl lg:max-w-4xl">
      ...
      <ul className="w-full flex flex-col md:flex-row gap-8">
        <motion.li
          className="w-full shadow-lg shadow-[#e9f15380] rounded-2xl"
          whileHover={{ scale: 1.05 }}
          transition={{ type: "spring", stiffness: 400, damping: 10 }}
        >
          <Link href={`/blog/${recentPosts[0].slug}`}>
            <div className="w-full h-full bg-gradient-to-br p-2 rounded-2xl from-[#f05757] to-[#e9f153] bg-500 animate-gshift">
        ...
        <motion.li
          className="w-full shadow-lg shadow-[#4fd96680] rounded-2xl"
          whileHover={{ scale: 1.05 }}
          transition={{ type: "spring", stiffness: 400, damping: 10 }}
        >
          <Link href={`/blog/${recentPosts[1].slug}`}>
            <div className="w-full h-full bg-gradient-to-tr p-2 rounded-2xl from-[#4fd966] to-[#0575E6] bg-500 animate-gshift">
              <div className="w-full h-full p-4 bg-gray-100 dark:bg-gray-900 rounded-xl flex flex-col justify-between gap-y-4">
                <div className="flex flex-col gap-y-1">
                  <h2 className="text-lg font-semibold">
                    {recentPosts[1].title}
        ...
        <motion.li
          className="w-full shadow-lg shadow-[#EF629F80] rounded-2xl"
          whileHover={{ scale: 1.05 }}
          transition={{ type: "spring", stiffness: 400, damping: 10 }}
        >
          <Link href={`/blog/${recentPosts[2].slug}`}>
            <div className="w-full h-full bg-gradient-to-br p-2 rounded-2xl from-[#EECDA3] to-[#EF629F] bg-500 animate-gshift">
              <div className="w-full h-full p-4 bg-gray-100 dark:bg-gray-900 rounded-xl flex flex-col justify-between gap-y-4">
                <div className="flex flex-col gap-y-1">
                  <h2 className="text-lg font-semibold">
                    {recentPosts[2].title}
