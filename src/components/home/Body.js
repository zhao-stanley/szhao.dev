...
export default function Body({ numberPosts, githubFollowers }) {
  ...
  return (
    <section className="flex flex-col gap-8">
      <div
        className="relative h-24 w-24 sm:h-32 sm:w-32 lg:w-48 lg:h-48 flex-shrink-0 overflow-hidden rounded-full hover:rotate-[360deg] duration-[1.375s] hover:scale-110 hover:hue-rotate-180 transition ease-in-out select-none"
        style={{ boxShadow: `0 5px 10px -1px #fe99b6` }}
      >
        <Image
